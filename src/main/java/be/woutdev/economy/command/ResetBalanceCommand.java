...
public class ResetBalanceCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        Transaction transaction = EconomyAPI.getAPI().createTransaction(account.get(), TransactionType.WITHDRAW, account.get().getBalance());
        ...
        EconomyAPI.getAPI().transact(transaction).addListener((t) -> {
            ...
            {
                sender.sendMessage(ChatColor.RED + "Error resetting balance of " + recipient.getName() + "! Error: " + t.getResult().getStatus());
            }
        });
